...
# The ComParE 2019 StyrianDialects (SD) audio files differ in length. By setting the --fixed-length option, we make sure that all
# audio files are exactly 2 seconds long. This is achieved by cutting or zero-padding audio files as required.
fixed_length="2"
...
parser="audeep.backend.parsers.compare19_sd.Compare19SDParser"
...
export_basename="ComParE2019_StyrianDialects.auDeep"
