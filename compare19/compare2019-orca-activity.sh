...
# The ComParE 2019 OrcaActivity (OA) audio files differ in length. By setting the --fixed-length option, we make sure that all
# audio files are exactly 3 seconds long. This is achieved by cutting or zero-padding audio files as required.
fixed_length="3"
...
parser="audeep.backend.parsers.compare19_oa.Compare19OAParser"
...
export_basename="ComParE2019_OrcaActivity.auDeep"
